...
import { InputField as InputFieldComponent } from "../components/InputField/InputField"
...
export const InputFieldWithAction = (props: any) => {
	return (
		<InputFieldComponent
			action={<Icon onClick={() => alert("clicked")}>visibility</Icon>}
			{...props}
		/>
	)
}
...
export const InputFieldWithText = (props: any) => {
	return (
		<InputFieldComponent
			text={<StyledErrorText size={"small"} children="this is my small text" />}
			{...props}
		/>
	)
}
